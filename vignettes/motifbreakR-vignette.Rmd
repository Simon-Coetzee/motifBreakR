...
#import the BED file
snps.mb.frombed <- snps.from.file(bedfile = snps.bed.file,
                                  dbSNP = SNPlocs.Hsapiens.dbSNP.20120608,
                                  search.genome = BSgenome.Hsapiens.UCSC.hg19,
                                  format = "bed")
snps.mb.frombed
...
snps.mb.frombed <- snps.from.file(bedfile = snps.bedfile.nors,
...
plotMB(results = results, rsid = "rs7837328", stackmotif = TRUE, effect = "strg")
```

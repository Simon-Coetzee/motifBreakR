...
This guide includes a detailed section on the [scoring methods](#methods), a brief overview of the [processing flow](#flow), and an example focusing more in depth on the [practical](#practical) aspect of using `r Githubpkg("Simon-Coetzee/motifBreakR")`
...
This straightforward process allows the interrogation of SNPs and SNVs across the many different species represented by `r Biocpkg("BSgenome")` packages (at least 22 different species)
